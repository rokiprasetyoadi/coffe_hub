            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="thumb">
                            <img style="padding: 15px; border-radius: 40px;" src="<?= base_url('assets/upload/e_catalog/'.$k->catalog_img) ?>" alt="">
                        ...
                        <div class="place_info" style="height: 220px;">
                            ...
                            <div class="rating_days d-flex justify-content-between">
                                ...
                                <div class="days">
                                    ...
                                    <a href="<?php echo site_url('front_end/EKatalog/detail_ekatalog/'.$k->catalog_id) ?>"><?php echo $k->catalog_lokasi ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
